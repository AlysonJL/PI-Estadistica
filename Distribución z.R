...
#Las calificaciones de la materia de español
#del 2°"A" de la escuela "Francisco Javier Azcoitia, se ajustan a una
#distribución normal.

# 1.- Generar las calificaciones de Ciencias
# 19: número de alumnas/os
x<-sample(5:10, 19, replace=TRUE)
x
